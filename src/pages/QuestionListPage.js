...
function QuestionListPage() {
  ...
  const questionKeyWord = searchParams.get("keyword");
  const [keyword, setKeyword] = useState(questionKeyWord || "");
  const questions = getQuestions(questionKeyWord);
  ...
  return (
    ...
    >
      ...
      {questionKeyWord && questions.length === 0 ? (
        <Warn
